json.extract! user, :id, :first_name, :last_name, :email, :phone_number, :password_digest, :profile_photo, :admin_permission, :bio, :street_address, :unit_number, :city, :state, :zip_code
